...
cd /tmp
set -e 
 wget "https://raw.githubusercontent.com/Ham-ahmed/oDreamy-mini/main/oDreamyFHD_mini-posterX-v2_Mod_HAhmed.tar.gz"
wait
tar -xzf oDreamyFHD_mini-posterX-v2_Mod_HAhmed.tar.gz  -C /
wait
cd ..
set +e
rm -f /tmp/oDreamyFHD_mini-posterX-v2_Mod_HAhmed.tar.gz
sleep 2;
echo "" 
echo "" 
echo "**************************************************************************************************"
